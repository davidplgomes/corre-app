-- =====================================================
-- QR signature compatibility fallback
-- Replaces hmac dependency with deterministic built-in md5
-- to avoid runtime function resolution issues across environments.
-- =====================================================
...
BEGIN
  ...
  v_signature := md5(
    p_user_id::TEXT || ':' || v_timestamp::TEXT || ':' || v_secret
  );
